        ...
        GeometryReader{ geo in
            ...
            ZStack{
                ...
                VStack{
                    ...
                    FirebaseImageView(imageURL: self.user.photoURL).frame(width: geo.size.width * 1, height: geo.size.height * 0.4).cornerRadius(10).shadow(radius: 2, x: 2, y: 5).padding(.vertical).animation(.spring())
