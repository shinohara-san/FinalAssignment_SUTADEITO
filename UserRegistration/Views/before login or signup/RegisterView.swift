                        ...
                        VStack{
                            Section{
                                ...
                                SecureField("password", text: self.$password)
                                    .textFieldStyle(CustomTextFieldStyle(geometry: geometry))
                                    .padding().keyboardType(.emailAddress)
                                Text("※Eメールとパスワードはログイン時に使用します。").foregroundColor(self.shareData.pink).font(.footnote)
                                ...
                                TextField("subject", text: self.$subject)
                                    .textFieldStyle(CustomTextFieldStyle(geometry: geometry))
                                    .padding()
                                TextField("introduction", text: self.$introduction)
                                    .textFieldStyle(CustomTextFieldStyle(geometry: geometry))
                                    .padding()
                                TextField("studystyle", text: self.$studystyle)
                                    .textFieldStyle(CustomTextFieldStyle(geometry: geometry))
                                    .padding()
